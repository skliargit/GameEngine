...
typedef enum memory_tag {
    MEMORY_TAG_UNKNOWN,     /**< Неизвестный или неопределенный тип памяти.            */
    MEMORY_TAG_DARRAY,      /**< Память используемая динамическими массивами.          */
    MEMORY_TAG_STRING,      /**< Память используемая для хранения строк.               */
    MEMORY_TAG_APPLICATION, /**< Память используемая приложением.                      */
    MEMORY_TAG_SYSTEM,      /**< Память используемая системами движка.                 */
    MEMORY_TAG_RENDERER,    /**< Память используемая рендерером.                       */
    MEMORY_TAG_TEXTURE,     /**< Память используемая для текстурны данных.             */
    MEMORY_TAG_COUNT        /**< Количество тегов памяти (не является реальным тегом). */
} memory_tag;
