...
*/
platform_window_t* wayland_window_create(const platform_window_config_t* config, void* internal_data);
...
/*
    ...
    @param internal_data Указатель на внутренние данные бэкенда.
*/
void wayland_window_destroy(platform_window_t* window, void* internal_data);
...
*/
const char* wayland_window_get_title(platform_window_t* window);
...
*/
void wayland_window_get_resolution(platform_window_t* window, u32* width, u32* height);
...
*/
void wayland_window_set_event_callback(platform_window_t* window, platform_window_event_t event, platform_window_event_callback callback, void* user_data);
...
*/
u32 wayland_window_create_vulkan_surface(platform_window_t* window, void* vulkan_instance, void* vulkan_allocator, void** out_vulkan_surface);
...
*/
void wayland_window_destroy_vulkan_surface(platform_window_t* window, void* vulkan_instance, void* vulkan_allocator, void* vulkan_surface);
...
*/
u32 wayland_window_supports_vulkan_presentation(platform_window_t* window, void* vulkan_pyhical_device, u32 queue_family_index);
